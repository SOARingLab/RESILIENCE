...
public class VerifierController {
    ...
    // public Map<String, List<String>> verifyFunctional(@RequestBody Map<String,
    ...
    @PostMapping(value = "/build-controllability")
    public ControllabilityModel buildControllability(@RequestBody ControllabilityModel controllabilityModel)
            throws Exception {
        return verifierService.buildControllability(controllabilityModel);
    }

    @PostMapping(value = "/verify-controllability")
    public ControllabilityModel verifyControllability(@RequestBody ControllabilityModel controllabilityModel)
            throws Exception {
        return verifierService.verifyControllability(controllabilityModel);
    }

    @GetMapping(value = "/verify-test")
    public void verifyTest(String name) throws Exception {
        verifierService.verifyTest(name);
    }
}
